...
; redis-17022.c23632.us-east-1-mz.ec2.cloud.rlrcp.com:17022
;redis-cli -u redis://default:wNQ51CkNO8hGF7KsBaLBnDUgOOeEZKAJ@redis-17022.internal.c23632.us-east-1-mz.ec2.cloud.rlrcp.com:17022
;redis-cli -u redis://default:BYXf1PzY5uLRMmx4GCtMDOcC1FdK2YbE@redis-18797.c278.us-east-1-4.ec2.redns.redis-cloud.com:18797
;redis-cli -u redis://default:8fuQTrAtYd8zmC2SeHTQRCdA7SWgbt8A@redis-15951.c49334.us-east-1-mz.ec2.cloud.rlrcp.com:15951
(def conn-opts
  {:spec {:host "redis-15951.c49334.us-east-1-mz.ec2.cloud.rlrcp.com"
          :port 15951
          :username "default"
          :db 0           ; Use database 15 for tests
          :password "8fuQTrAtYd8zmC2SeHTQRCdA7SWgbt8A" ; If auth is needed
          :timeout-ms 4000}})
;(def conn-opts {})  ; Uses localhost:6379
...
(deftest benchmarks-tests
  (is (benchmarks/bench {:conn-opts conn-opts :n-commands 20 :warmup-laps 1})))
